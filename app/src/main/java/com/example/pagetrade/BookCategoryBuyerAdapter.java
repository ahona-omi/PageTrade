...
public class BookCategoryBuyerAdapter extends RecyclerView.Adapter<BookCategoryBuyerAdapter.ViewHolder> implements Filterable {
    Context context;
    public List<BookCategoryModel> bookCategoryModelList,filterList;
    private String selectedTitle;
    private FilterCatBuyer filterCat;
    public BookCategoryBuyerAdapter(Context context, List<BookCategoryModel> bookCategoryModelList) {
    ...
    @NonNull
    @Override
    public BookCategoryBuyerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.designrow_rv,parent,false);

        return new BookCategoryBuyerAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull BookCategoryBuyerAdapter.ViewHolder holder, int position) {
    ...
    private void openItemDetails(BookCategoryModel bookCategoryModel) {
        ...
        Intent intent = new Intent(context, BookItemBuyerActivity.class);
    ...
    public Filter getFilter() {
        if(filterCat==null) {
            filterCat= new FilterCatBuyer(filterList,this);
        }
        return filterCat;
    }
