...
public class ProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void updateProfile() {
        ...
        if (TextUtils.isEmpty(setName) && TextUtils.isEmpty(setAddress) && TextUtils.isEmpty(setPhone)) {
            Toast.makeText(ProfileActivity.this, "Please enter at least one information", Toast.LENGTH_SHORT).show();
        } else {
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            if (requestCode == GalleryPick) {
                ...
                if (imgUri != null) {
                    ...
                    Toast.makeText(ProfileActivity.this, "Image Uri is null", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            }
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id ==R.id.nav_home){
            Intent cartIntent = new Intent(ProfileActivity.this, MainActivity.class);
            startActivity(cartIntent);
        } else if(id==R.id.nav_vieworder){
            Intent viewOrderIntent = new Intent(ProfileActivity.this, VieworderActivity.class);
            startActivity(viewOrderIntent);
        } else if(id==R.id.nav_addbook){
            Intent viewOrderIntent = new Intent(ProfileActivity.this, AddedBookItemActivity.class);
            startActivity(viewOrderIntent);
        } else if(id==R.id.nav_logout){
            FirebaseAuth.getInstance().signOut();
            Intent viewOrderIntent = new Intent(ProfileActivity.this, LoginActivity.class);
            startActivity(viewOrderIntent);
        } else if(id==R.id.nav_share){
            Intent viewOrderIntent = new Intent(ProfileActivity.this, ShareActivity.class);
            startActivity(viewOrderIntent);
        } else if(id==R.id.nav_rate){
            Intent viewOrderIntent = new Intent(ProfileActivity.this, RateusActivity.class);
            startActivity(viewOrderIntent);
        }
