...
public class BookCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel.setOnClickListener(view -> {
            startActivity(new Intent(BookCategoryActivity.this, MainActivity.class));
        });
    ...
    private void uploadBookCategory() {
        String title = editText.getText().toString().trim();
        if (!(title.isEmpty() || imageUri == null)) {
            progressDialog.setTitle("Uploading Book Category...");
            progressDialog.show();
            ...
            filePath.putFile(imageUri).addOnSuccessListener(taskSnapshot -> {
                ...
                downloadUrl.addOnCompleteListener(task -> {
                    ...
                    Toast.makeText(BookCategoryActivity.this, "Book Category added successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(BookCategoryActivity.this, MainActivity.class));
                });
            });
        } else {
