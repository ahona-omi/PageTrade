...
public class FilterCatPdf extends Filter {
    List<BookCategoryModel> filterList;
    PdfCategoryAdapter categoryAdapter;

    public FilterCatPdf(List<BookCategoryModel> filterList, PdfCategoryAdapter categoryAdapter) {
