...
public class FilterCatPdfBuyer extends Filter {
    List<BookCategoryModel> filterList;
    PdfCategoryBuyerAdapter categoryAdapter;

    public FilterCatPdfBuyer(List<BookCategoryModel> filterList, PdfCategoryBuyerAdapter categoryAdapter) {
