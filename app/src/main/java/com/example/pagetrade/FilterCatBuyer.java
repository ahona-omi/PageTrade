...
public class FilterCatBuyer extends Filter {
    List<BookCategoryModel> filterList;
    BookCategoryBuyerAdapter categoryAdapter;

    public FilterCatBuyer(List<BookCategoryModel> filterList, BookCategoryBuyerAdapter categoryAdapter) {
