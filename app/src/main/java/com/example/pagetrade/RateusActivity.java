...
public class RateusActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id ==R.id.nav_home){
            Intent cartIntent = new Intent(RateusActivity.this, MainActivity.class);
            startActivity(cartIntent);
        } else if(id==R.id.nav_vieworder){
            Intent viewOrderIntent = new Intent(RateusActivity.this, VieworderActivity.class);
            startActivity(viewOrderIntent);
        } else if(id==R.id.nav_profile){
            Intent viewOrderIntent = new Intent(RateusActivity.this, ProfileActivity.class);
            startActivity(viewOrderIntent);
        } else if(id==R.id.nav_addbook){
            Intent viewOrderIntent = new Intent(RateusActivity.this, AddedBookItemActivity.class);
            startActivity(viewOrderIntent);
        } else if(id==R.id.nav_logout){
            FirebaseAuth.getInstance().signOut();
            Intent viewOrderIntent = new Intent(RateusActivity.this, LoginActivity.class);
            startActivity(viewOrderIntent);
