...
public class BookCategoryAdapter extends RecyclerView.Adapter<BookCategoryAdapter.ViewHolder> implements Filterable {
    Context context;
    public List<BookCategoryModel> bookCategoryModelList, filterList;
    private boolean isAddedBookActivity;
    private String selectedTitle;
    private FilterCat filterCat;

    public BookCategoryAdapter(Context context, List<BookCategoryModel> bookCategoryModelList, boolean isAddedBookActivity) {
    ...
    public Filter getFilter() {
        if(filterCat==null) {
            filterCat= new FilterCat(filterList,this);
        }
        return filterCat;
    }
